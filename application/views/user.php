					...
					<a><img style="width:112%; height:190px; position:relative;right:6%;" src="<?php echo base_url(). '/upload/' . $brg->gambar ?>" class="card-img-top" ></a>
						<div class="card-body mt-1 mb-3">
							<div class="row">
								...
								<?php echo anchor('detail_produk/detail/' . $brg->produk_id, '<h8 class="card-title" style="font-size:13px;   color: rgb(85, 84, 84); text-decoration:none;">'.$brg->nama.'</h8>', 'style="text-decoration:none;"')?>
