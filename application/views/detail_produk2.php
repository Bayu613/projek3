 ...
 <div class="containe-fluid" style="margin-top:7rem; width:1300px; height:300px; position:relative;left:15%; " >
    <div class="card" style="box-shadow:0 0 15px 2px  white;">
      ...
      <?php foreach($barang as $brg): ?>
        <div class="row" >
            <div class="col-md-1">
                <img style="width:720%; height:100%;box-shadow:0 0 50px 1px  rgb(194,194,194); border-radius:2px;" src="<?php echo base_url(). '/upload/' . $brg->gambar ?>" class="card-img-top" >
        ...
        <div class="col-md-8" style="position:relative;left:45%;">
            <table style="margin-top:10%;">
                ...
                <a href="<?php echo base_url('auth/login')?>" ><h class="btn btn-dark  p-3 rounded-0 text-warning " style="font-size:13px; width:550px; position:relative;top:33rem;">Lanjutkan Pembayaran</h></a>
            </table>
        </div>
    </div>
</div>
