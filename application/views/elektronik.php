...
background: linear-gradient(0deg, rgb(20,80,155) 8%, rgb(255,255,255) 10%);  box-shadow:0 0 15px 2px  rgb(194,194,194);">
    ...
    <a class="btn btn-dark rounded-0 " href="<?php echo base_url('kategori/elektronik_all')?>" style="text-decoration:none;  color: white; position:relative;left:32.3rem; font-size:12px;">Lihat Semua</a>
</div>
</div>
